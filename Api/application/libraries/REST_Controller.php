...
abstract class REST_Controller extends CI_Controller {
    ...
    {
      $userInfo = $this->input->get_request_header('Authorization', TRUE);
      if(!empty($userInfo)) {
        $userInfo = str_replace('Basic ','', $userInfo);
        $this->userInfo = json_decode($this->encrypt->decode($userInfo));
        if(empty($this->userInfo) || empty($this->userInfo->idUser ) || empty($this->userInfo->idProfileUser )) {
